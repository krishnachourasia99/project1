...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `cabinateAdmin`(name, price, disc, image,  categories) VALUES('$p_name', '$p_price', '$p_disc', '$p_image' ,'cabinate')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `cabinateAdmin` WHERE id = $delete_id ") or die('query failed');
   ...
   if($delete_query && $delete_query_total){
      header('location:cabinateadmin.php');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `cabinateAdmin` SET name = '$update_p_name', price = '$update_p_price', disc ='$update_p_disc',image = '$update_p_image' WHERE id = '$update_p_id'");
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   <h3>add a new cabinate product</h3>
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="cabinateadmin.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="cabinateadmin.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
   ...
   if(isset($_GET['edit'])){
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `cabinateAdmin` WHERE id = $edit_id");
